...
//  EarthAR
//
//  Created by Marcus Ng on 12/5/17.
...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    func addNodeAtLocation(location: CGPoint) {
        ...
        if hitResults.count > 0 {
            ...
            let newLocation = SCNVector3(x: result.worldTransform.columns.3.x, y: result.worldTransform.columns.3.y + 0.75, z: result.worldTransform.columns.3.z)
